      ...
      <div className="relative flex flex-col md:flex-row items-start gap-4 md:gap-6">
        <div className="flex-1">
          ...
          <div className="mt-2 text-sm muted flex flex-wrap gap-x-4 gap-y-1 items-center">
            <span className="flex items-center gap-1"><FiPhone />+86 13143745768</span>
            ...
            <Link href="weixin://dl/chat?13143745768" target="_blank" className="custom-link flex items-center gap-1"><FaWeixin />{language === 'zh' ? '微信' : 'WeChat'}</Link>
